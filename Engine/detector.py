...
cap = cv2.VideoCapture("/home/3tec/TCC TEC/TCC_CAM/Engine/video.mp4")
...
with vision.FaceLandmarker.create_from_options(options) as landmarker:
    while True:
        ...
        if not results.face_landmarks:
            ...
            cv2.putText(frame, f"Angulo: {angulo:.1f}", (10, 80),
        ...
        cv2.putText(frame, f"Sem rosto: {tempo_sem_rosto:.1f}s", (10, 110),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.6, (200, 200, 200), 1)
        cv2.putText(frame, f"Cab. abaixada: {tempo_cabeca_inclinada:.1f}s", (10, 135),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.6, (200, 200, 200), 1)
